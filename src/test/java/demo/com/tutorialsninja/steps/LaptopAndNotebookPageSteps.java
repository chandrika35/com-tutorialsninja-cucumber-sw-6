...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Sita");
        new CheckoutPage().enterLastName("Ram");
        new CheckoutPage().enterEmailId("sitaram_123@gmail.com");
        new CheckoutPage().enterTelephone("07345364657");
        new CheckoutPage().enterAddressLine1("111,Moores Mension");
        new CheckoutPage().enterCity("London");
        new CheckoutPage().enterPostCode("W2 4TJ");
        new CheckoutPage().selectCountry("United Kingdom");
        new CheckoutPage().selectRegion("Ware");
    }
